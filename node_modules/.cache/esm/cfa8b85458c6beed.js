let dayjs,minimist,readline,uuidv4,shortUUID;_58c‍.w("dayjs",[["default",["dayjs"],function(v){dayjs=v}]]);_58c‍.w("minimist",[["default",["minimist"],function(v){minimist=v}]]);_58c‍.w("readline",[["default",["readline"],function(v){readline=v}]]);_58c‍.w("uuid",[["v4",["uuidv4"],function(v){uuidv4=v}]]);_58c‍.w("short-uuid",[["default",["shortUUID"],function(v){shortUUID=v}]]);
	...
	switch (cmd) {
		...
		case 'updateversion':
			...
			fs.writeFile('./package.json', output, function (err) {
				if (err)
					return _58c‍.g.console.error(err);
		...
		case 'help':
			...
			_58c‍.g.console.log(menus.default)
			break;
